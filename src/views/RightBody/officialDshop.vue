<template>
  <div class="container">
    ...
    <div class="box">
      ...
      <el-card  style="max-width: 480px" @click="handleAIf" class="clickable-card">
        ...
        <p class="agent-desc">智谱开放平台AI智能客服魔镜体，知识库内容为专有知识不支持复制，需替换自有知识库</p>
        <div class="agent-tags">
          <span class="tag">商业服务</span>
          <span class="tag">工作提效</span>
        </div>
