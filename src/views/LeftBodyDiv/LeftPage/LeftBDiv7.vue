<template>
    ...
    <el-button type="info" :icon="User" circle @click="Shen"  style="position:absolute; top: 770px;left: 10px;"/>
    <el-button type="danger" :icon="Delete" circle @click="deleteFriend" style="position:absolute; top: 770px;left: 60px;"/>
    <el-button :icon="Search" circle @click="searchUser" style="position:absolute; top: 770px;left: 110px;"/>
